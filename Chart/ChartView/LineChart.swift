...
//  Chart
//
//  Created by Amir Sheibani on 6/6/18.
...
class LineChart {
    ...
    var lineChartTitle = ""
    var lineChartTitleColor = UIColor.clear
    var pointLocation = [CGPoint]()
    
    init(lineChart: StructLineChart,rotationState: RotationState,lineChartTitle: String,lineChartTitleColor: UIColor) {
        self.lineChartTitle = lineChartTitle
        self.lineChartTitleColor = lineChartTitleColor
